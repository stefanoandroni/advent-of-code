...
def main():
    ...
    while i < ROUND:
        ...
        EM = []  # EM: list of elves who have to move 
        REL = [] # REL: list of elves for the current round
        NP = [] # NP: list of point pairs (position), (new position proposed) 
    ...
    print(count_empty_tiles(EL)) # <Part 1>
